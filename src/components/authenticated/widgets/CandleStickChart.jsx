...
export default function CandleStickChart({containerWidth, containerHeight}) {
    const [ width, setWidth ] = useState(containerWidth)
    const [ height, setHeight ] = useState(containerHeight-50)
    ...
    }}, [data, dates, currentZoomState, width, height])
    ...
    return (
        <>
        <div width={width} className='absolute'>
            ...
            <div className='text-black block m-auto h-full relative'>
