    ...
    return (
        <div id='features' className='relative mt-20 border-b border-neutral-800'>
            <div className='text-center'>
                <span className='font-gothic bg-gray-200 text-accent rounded-full h-6 text-sm font-medium px-2 py-1 uppercase'>
                    Features
                </span>
                <h2 className='font-gothic font-medium text-3xl sm:text-5xl lg:text-6xl mt-10 lg:mt-20 tracking-wide'>
                    <span className="text-accent-secondary font-xl text-5xl">
                            Research {' '}
                    </span>
                    & Analysis Tools
                </h2>
            ...
            <div className='flex flex-wrap mt-10 lg:mt-20'>
                <div className='w-full sm:1/2 lg:w-1/3'>
                    <div className='flex'>
                        <div className='flex mx-6 h-10 w-10 p-2 bg-gray-200 text-accent justify-center items-center rounded-full'>
                        ...
                        <div className=''>
                            ...
                            <p className='font-gothic font-medium text-md p-2 mb-20 text-neutral-500'>
                ...
                <div className='w-full sm:1/2 lg:w-1/3'>
                    <div className='flex'>
                        <div className='flex mx-6 h-10 w-10 p-2 bg-gray-200 text-primary justify-center items-center rounded-full'>
