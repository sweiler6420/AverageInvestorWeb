    ...
    return (
        <div id='workflow' className='mt-20'>
            <h2 className='font-gothic font-medium text-3xl sm:text-5xl lg:text-6xl text-center mt-6 tracking-wide'>
                ...
                <span className="text-accent font-xl text-5xl">
                    {" "}
                    Technology
                </span>
            </h2>
            <div className='flex flex-wrap justify-center lg:items-stretch'> 
                ...
                <div className='pt-12 w-full lg:w-1/2'>
                    <div className='flex mb-12'>
                        <div className='text-green-500 mx-6 bg-gray-200 h-10 w-10 p-2 justify-center items-center rounded-full'>
                        ...
                        <div>
                            ...
                            <p className='font-gothic font-medium text-md p-2 mb-10 text-neutral-500'>
